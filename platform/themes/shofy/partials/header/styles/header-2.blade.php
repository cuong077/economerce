<header>
    <div @class(['tp-header-area tp-header-height', 'tp-header-style-primary' => BaseHelper::isHomePage()])>
        {!! Theme::partial('header.top', ['colorMode' => 'light', 'headerTopClass' => 'container', 'showUserMenu' => true]) !!}

        <div id="header-sticky" class="tp-header-bottom-2 tp-header-sticky" {!! Theme::partial('header.sticky-data') !!}>
            <div class="container">
